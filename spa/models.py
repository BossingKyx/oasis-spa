...
class Service(models.Model):
    ...
    name = models.CharField(max_length=120)          # unique full name (e.g. "Swedish (90 min)")
    category = models.CharField(max_length=60, blank=True)
    group = models.CharField(max_length=120, blank=True)   # base service (e.g. "Swedish")
    variant = models.CharField(max_length=60, blank=True)  # tier label (e.g. "90 min", "Female")
    duration_minutes = models.PositiveIntegerField(default=60)
    price = models.DecimalField(max_digits=10, decimal_places=2, default=0)
    sort_order = models.PositiveIntegerField(default=0)     # preserves menu order
    is_active = models.BooleanField(default=True)
